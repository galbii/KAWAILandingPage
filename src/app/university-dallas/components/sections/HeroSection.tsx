      ...
      <div className="relative z-30 w-full max-w-7xl mx-auto px-4 sm:px-6 text-center hero-content py-8 sm:py-12 lg:pt-20 lg:pb-12">
        ...
        <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto px-2">
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <div className="text-sm sm:text-base text-white/95 drop-shadow-sm hero-animate hero-animate-7">Schedule your personal appointment with KAWAI piano experts for personalized recommendations and guidance</div>
          </div>
