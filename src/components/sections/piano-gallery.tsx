      ...
      <section className="py-12 text-center bg-kawai-pearl">
        <div className="max-w-2xl mx-auto px-6 space-y-4">
          ...
          <p className="text-sm text-blue-600 font-medium">
            September 11th-14th experiences available • Walk-ins welcome
          </p>
        </div>
      </section>
