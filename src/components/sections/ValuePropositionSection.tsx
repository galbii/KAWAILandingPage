    ...
    <section className="relative py-12 lg:py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          {/* Modern Technology */}
          <div className="text-center card-animate-1">
            <div className="relative mb-6">
              <div className="w-20 h-20 mx-auto bg-gradient-primary rounded-full flex items-center justify-center shadow-premium">
          ...
          <div className="text-center card-animate-2">
            <div className="relative mb-6">
              <div className="w-20 h-20 mx-auto bg-gradient-primary rounded-full flex items-center justify-center shadow-premium">
                <Piano 
          ...
          {/* 10 Year Warranty */}
          <div className="text-center card-animate-3">
            <div className="relative mb-6">
              <div className="w-20 h-20 mx-auto bg-gradient-primary rounded-full flex items-center justify-center shadow-premium">
                <Shield 
                  className="icon-float w-10 h-10 text-white"
